...
const Message: React.FC<{message: messageType}> = ({message}) => {
  ...
  return (
    <div className='w-full mt-[17px] py-[2px] pr-12 pl-[72px] relative'>
      <div className='absolute left-3'>
        <img src={subtituteicons} className='size-12 bg-highdarkgray p-2 rounded-full' />
      </div>
      <div className='flex flex-col gap-1 '>
        <div className='flex items-center'>
          <h3 className='font-semibold text-slate-200 hover:underline  cursor-pointer text-sm'>{message.name}</h3>
